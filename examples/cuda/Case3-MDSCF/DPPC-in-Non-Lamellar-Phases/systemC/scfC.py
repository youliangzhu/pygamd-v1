...
filename = 'scfC.xml'# initial configuration file
...
lj = gala.LJForce(all_info, neighbor_list, 0.9000) #(,,rcut)
...
scf = gala.MDSCFForce(all_info,    18,    18,    18, 0.100)#(mx,my,mz,compressibility)
