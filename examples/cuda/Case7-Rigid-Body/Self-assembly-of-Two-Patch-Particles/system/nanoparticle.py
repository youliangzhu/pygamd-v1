...
neighbor_list.addExclusionsFromBodies() # remove the interactions of particles in a same body
...
lj.setParams('B', 'B' ,1.0 ,1.0 ,1.0, 3.0)#type, type, epsilon, sigma, alpha, rcut
