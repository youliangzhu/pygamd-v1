...
neighbor_list.setRCutPair("P", "P", 3.64)
...
neighbor_list.setRCutPair("A", "P", 3.64)
neighbor_list.setRCutPair("A", "W", 1.0)
neighbor_list.setRCutPair("C", "P", 3.64)
neighbor_list.setRCutPair("C", "W", 1.0)

neighbor_list.setRCutPair("PC", "PC", 3.64)
neighbor_list.setRCutPair("PC", "P", 3.64)
neighbor_list.setRCutPair("PC", "C", 3.64)
neighbor_list.setRCutPair("PC", "A", 3.64)
neighbor_list.setRCutPair("PC", "W", 1.0)
...
dpd.setParams("PC", "P", 78.3, 3.0)
dpd.setParams("PC", "A", 78.3, 3.0)
dpd.setParams("PC", "C", 78.3, 3.0)
dpd.setParams("PC", "PC", 78.3, 3.0)
dpd.setParams("PC", "W", 78.3, 3.0)
