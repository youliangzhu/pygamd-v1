...
unsigned int MSTReader::getNDimensions() const
    {
    return (unsigned int)m_dimension;
    }

unsigned int MSTReader::getNParticles() const
    {
    return m_num_particles;
    }
	
unsigned int MSTReader::getLastNParticles() const
    {
    return m_last_np;
    }	

unsigned int MSTReader::getNParticleTypes() const
    {
    return (unsigned int)m_type_map.size();
    }

BoxSize MSTReader::getBox() const
    {
    return m_box;
    }

unsigned int MSTReader::getTimeStep() const
    {
    return m_timestep;
    }
...
unsigned int MSTReader::getTypeId(const std::string& name) 
    {
...
unsigned int MSTReader::getBondTypeId(const std::string& name)
    {
...
unsigned int MSTReader::getAngleTypeId(const std::string& name)
    {
...
unsigned int MSTReader::getDihedralTypeId(const std::string& name)
    {
...
unsigned int MSTReader::getVsiteTypeId(const std::string& name)
    {
...
unsigned int MSTReader::getNBondTypes()  const
    {
    return (unsigned int)m_bond_type_map.size();
    }

unsigned int MSTReader::getNAngleTypes() const 
    {
    return (unsigned int)m_angle_type_map.size();
    }

unsigned int MSTReader::getNDihedralTypes() const
    {
    return (unsigned int)m_dihedral_type_map.size();
    }

unsigned int MSTReader::getNVsiteTypes() const
    {
